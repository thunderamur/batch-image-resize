...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_Source.setGeometry(QtCore.QRect(100, 10, 371, 27))
        self.lineEdit_Source.setObjectName("lineEdit_Source")
        self.lineEdit_Destination = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_Destination.setGeometry(QtCore.QRect(100, 50, 371, 27))
        ...
        self.pushButton_Source.setGeometry(QtCore.QRect(10, 10, 85, 27))
        ...
        self.label_Quality.setGeometry(QtCore.QRect(240, 142, 101, 21))
        self.label_Quality.setObjectName("label_Quality")
        self.spinBox_Quality = QtWidgets.QSpinBox(self.centralwidget)
        self.spinBox_Quality.setGeometry(QtCore.QRect(350, 140, 41, 27))
        ...
        self.label_Preset.setGeometry(QtCore.QRect(10, 95, 54, 21))
        self.label_Preset.setObjectName("label_Preset")
        self.comboBox_Preset = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_Preset.setGeometry(QtCore.QRect(70, 90, 401, 33))
        ...
        self.pushButton_Start.setGeometry(QtCore.QRect(10, 180, 85, 27))
        self.pushButton_Start.setObjectName("pushButton_Start")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(100, 182, 371, 23))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.plainTextEdit_Output = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEdit_Output.setGeometry(QtCore.QRect(10, 220, 461, 121))
